...
El script `JordyRosario_20250737_Attack_DoS_CDP.py` automatiza la creación e inyección masiva de paquetes CDP maliciosos hacia un switch Cisco de destino.
...
```bash
sudo python3 JordyRosario_20250737_Attack_DoS_CDP.py [INTERFAZ]
```
...
sudo python3 JordyRosario_20250737_Attack_DoS_CDP.py

# Especificando una interfaz diferente
sudo python3 JordyRosario_20250737_Attack_DoS_CDP.py eth1
```
...
```bash
sudo python3 JordyRosario_20250737_Attack_DoS_CDP.py eth0
```
